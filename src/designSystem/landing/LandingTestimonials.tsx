...
const TestimonialCard = ({
  ...
  return (
    <div className="mb-8 sm:break-inside-avoid w-80 h-80 flex flex-col">
      <blockquote className="rounded-lg bg-gray-50 dark:bg-slate-800 p-6 shadow-sm sm:p-8 flex flex-col h-full">
        ...
        <p className="mt-4 text-gray-700 dark:text-slate-400 flex-grow">
          {content}
        </p>
      </blockquote>
    </div>
